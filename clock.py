...
def draw_clock():
    ...
    hms_width = graphics.measure_text(hms, 1.5)
    hms_offset = int((WIDTH / 2) - (hms_width / 2))
    h_width = graphics.measure_text(hms[0:2], 1.5)
    mi_width = graphics.measure_text(hms[3:5], 1.5)
    mi_offset = graphics.measure_text(hms[0:3], 1.5)
    ...
    graphics.text(hms, hms_offset, 40, scale=1.5)
